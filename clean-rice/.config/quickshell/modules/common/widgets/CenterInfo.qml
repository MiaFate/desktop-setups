...
Item {
    ...
    function getTempColor(tempStr) {
        ...
        if (!match) return Purpletheme.colFg
    ...
    Row {
        ...
        Text {
            text: dndEnabled ? "󰂛  " : "󰂚  "
            color: dndEnabled ? "#ff5555" : Purpletheme.colMuted
        ...
        Rectangle {
            id: weatherPill
            visible: weatherText !== ""
            color: popupVisible ? Purpletheme.colBg : "transparent"
            radius: 8
            height: 26
    ...
    PopupWindow {
        ...
        Canvas {
            ...
            onPaint: {
                ...
                ctx.fillStyle = Purpletheme.colBg
        ...
        Column {
            ...
            Text {
                ...
                color: Qt.rgba(Purpletheme.colMuted.r, Purpletheme.colMuted.g, Purpletheme.colMuted.b, 0.6)
                ...
                RowLayout {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            color: Qt.rgba(Purpletheme.colNetwork.r, Purpletheme.colNetwork.g, Purpletheme.colNetwork.b, 0.15)
                            radius: 4
                            ...
                            Rectangle {
                                ...
                                color: Qt.rgba(Purpletheme.colNetwork.r, Purpletheme.colNetwork.g, Purpletheme.colNetwork.b, 0.4 + (modelData / 200))
                                radius: 4
                            }
