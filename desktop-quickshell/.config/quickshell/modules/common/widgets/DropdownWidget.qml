...
Item {
    ...
    PopupWindow {
        ...
        anchor.rect.x: {
            var _trigger = dropdownOpen + root.x + root.y
            var absoluteX = root.mapToItem(null, 0, 0).x
            var iconCenter = absoluteX + iconContainer.x + iconContainer.width/2
        ...
        Canvas {
            ...
            onPaint: {
                ...
                ctx.reset()
                ctx.fillStyle = Purpletheme.bgPopup  // Purpletheme background
